...
return (
    ...
    <Text style={{fontSize:15 ,fontWeight:'semibold',color:`white`}}>{completeLoginObjData?.firstName}</Text>
    <Text style={{fontSize:15 ,fontWeight:'semibold',color:`white`,paddingRight:6}}>Can't change</Text>
        </View>
    </View>
    <View style={{backgroundColor:`#343434`,marginTop:16,marginLeft:8,marginRight:8,borderRadius:4}}>
        <View style={{flexDirection:'row',justifyContent:'space-between',paddingTop:12,paddingBottom:12}}>
    <Text style={{fontSize:15 ,fontWeight:'semibold',color:'grey',paddingLeft:6}}>Age : </Text>
    <Text style={{fontSize:15 ,fontWeight:'semibold',color:`white`}}>{age}</Text>
    <Text style={{fontSize:15 ,fontWeight:'semibold',color:`white`,paddingRight:6}}>Can't change</Text>
        </View>
    </View>
    ...
    <Text style={{fontSize:15 ,fontWeight:'semibold',color:`white`}}>{completeLoginObjData?.city}</Text>
    <Text style={{fontSize:15 ,fontWeight:'semibold',color:`white`,paddingRight:6}}>Can't change</Text>
        </View>
    </View>
    <Text style={{paddingTop:20,paddingLeft:6,paddingRight:6,textAlign:'center',
    color:`white`}}>Your profile will be shown to users in and around {completeLoginObjData?.city}.Your profile may also visible to users who have enabled matches from other cities</Text>
